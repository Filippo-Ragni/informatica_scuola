...
#creazione griglia del sudoku con, all'interno i valori predefiniti
...
#spiegazione di come inserire i numeri(presupponendo che il giocatore conosca le regole del sudoku)
...
if inizio == "":
    #remainder delle condizioni per interrompere il programma
    print ("da questo momento in poi ricorda che se fai 3 errori o se inserirai -invio-, il gioco si interromperà")
    while True:
        #print della griglia completa del sudoku con tutti i valori già inseriti
        print ()
        ...
        #assicurarsi che l'utente abbia inserito una colonna e una riga esistenti(lista e indice)
        ...
        #assicurarsi che l'utente non cerchi di cambiare dei numeri predefiniti
        else:
            if x == 0 and y == 1:
                ...
                #assicurarsi che l'utente non inserisca un numero non inseribile
                numero = int(input("che numero vuoi inserire?  "))
                if numero < 1 or numero > 9:
                    while numero < 1 or numero > 9:
                        numero = int(input("che numero vuoi inserire?  "))
                #inserimento dei numeri corretti nel caso l'utente abbia inserito uno di essi
                if y == 0 and x == 0 and numero == 4:
                    ...
                    riga9[x] = 9
                #aumento del conteggio del counter e comunicazione all'utente dell'errore commesso nel caso quaest'ultimo abbia sbagliato
                else:
                    errori += 1
                    print ("hai sbagliato")

        #check del counter e comunicazione della sconfitta + interruzione del programma nel caso in cui il counter abbia raggiunto il numero di errori non ammissibili
        if errori >= 3:
            print ("HAI PERSO, HAI COMMESSO TROPPI ERRORI!!")
            break

        #check della correttezza dei numeri inseriti ecomunicazione della vittoria + interruzione del programma nel caso in cui l'utente abbia inserito tutti i numeri corretti nella rispettiva cella(lista e indice)
